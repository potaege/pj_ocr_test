...
def main():
    ...
    ls = {
    "full_name_th":               'XXXXXXX',
    "identification_no":          'XXXXXXX',
    "sex":                        'XXXXXXX',
    "nationality":                'XXXXXXX',
    "date_of_birth":              'XXXXXXX',
    "place_of_birth":             'XXXXXXX',
    "house_registration_add":     'XXXXXXX',
    "mother_name_th":             'XXXXXXX',
    "mother_identification_no":   'XXXXXXX',
    "father_name_th":             'XXXXXXX',
    "father_identification_no":   'XXXXXXX',
    "registry_office":            'XXXXXXX',
    "date_of_birth_registration": 'XXXXXXX',
        }
